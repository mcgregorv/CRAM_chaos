...
colByFished <- rep(c(myBlue, myOrange),3)
axisCex=1.5
pdf(paste(plotPath,"EcoIndicators.pdf",sep=""), height=3.5, width=17)
par(mfrow=c(1,3), mar=c(4,5,1.5,1), oma=c(0,0,0,15))
...
par(xpd=NA)
legend(legend=c("Fished", "Unfished"), col=colByFished[1:2], lwd=3, seg.len=3, lty=1, x="right", bty="n", inset=-0.5, cex=2)
