...
thisDescriptions <- c("Informance", "Trophic level",  "Keystone ranking", "Responsive ranking", "Level 1 connections", "Lifespan (years)", 
                      "Additional adult mortality", "Additional juvenile mortality", "", "Diet proportion by top prey", "Linf")
...
pdf(paste(plotPath,"InteractionEffects_ASdata_allPointsPostBurnin.pdf", sep=""), height=6, width=12)
...
plotSingleEffect(thisVar="NumL1cons", this_model=this_model)
